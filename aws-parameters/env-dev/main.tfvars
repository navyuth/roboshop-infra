parameters = [
  ...
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devopscourse.online:8080/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devopscourse.online:8080/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopscourse.online:8080/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopscourse.online:8080/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopscourse.online:8080/", type = "String" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devopscourse.online:8080", type = "String" },
